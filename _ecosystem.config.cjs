  ...
  apps: [
    {
      ...
      env_production: { APP_ENV: "production", NODE_ENV: "production", NODE_OPTIONS: "--dns-result-order=ipv6first" },
      env_staging: { APP_ENV: "staging", NODE_ENV: "production", NODE_OPTIONS: "--dns-result-order=ipv6first" },
      env_file: envFile,
      max_restarts: 3,
      restart_delay: 5000,
    },
